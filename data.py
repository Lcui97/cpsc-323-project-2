...
action_table = {
     #This is the provided grammar table, translated to a dictonary of dicitonaries. 
     # First, look up the State
     # Next, find the token and associated action
     #
#State 
    0:  {'id': 'S5','(': 'S4'},
    1:  {'+':  'S6','-': 'S7','$': 'acc'},
